...
# Test Object Files
TESTOBJECTFILES= \
	${TESTDIR}/_ext/96b9438c/newtestclass2.o \
	${TESTDIR}/_ext/96b9438c/newtestrunner4.o
...
${TESTDIR}/TestFiles/f1: ${TESTDIR}/_ext/96b9438c/newtestclass2.o ${TESTDIR}/_ext/96b9438c/newtestrunner4.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc} -o ${TESTDIR}/TestFiles/f1 $^ ${LDLIBSOPTIONS}   `cppunit-config --libs`   


${TESTDIR}/_ext/96b9438c/newtestclass2.o: ../../M3105/tp5/tests/newtestclass2.cpp 
	${MKDIR} -p ${TESTDIR}/_ext/96b9438c
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/_ext/96b9438c/newtestclass2.o ../../M3105/tp5/tests/newtestclass2.cpp


${TESTDIR}/_ext/96b9438c/newtestrunner4.o: ../../M3105/tp5/tests/newtestrunner4.cpp 
	${MKDIR} -p ${TESTDIR}/_ext/96b9438c
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/_ext/96b9438c/newtestrunner4.o ../../M3105/tp5/tests/newtestrunner4.cpp
...
${OBJECTDIR}/_ext/414263ba/ArbreAbstrait_nomain.o: ${OBJECTDIR}/_ext/414263ba/ArbreAbstrait.o ../../M3105/tp5/ArbreAbstrait.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/414263ba/ArbreAbstrait_nomain.o ../../M3105/tp5/ArbreAbstrait.cpp;\
	else  \
...
${OBJECTDIR}/_ext/414263ba/Interpreteur_nomain.o: ${OBJECTDIR}/_ext/414263ba/Interpreteur.o ../../M3105/tp5/Interpreteur.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/414263ba/Interpreteur_nomain.o ../../M3105/tp5/Interpreteur.cpp;\
	else  \
...
${OBJECTDIR}/_ext/414263ba/Lecteur_nomain.o: ${OBJECTDIR}/_ext/414263ba/Lecteur.o ../../M3105/tp5/Lecteur.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/414263ba/Lecteur_nomain.o ../../M3105/tp5/Lecteur.cpp;\
	else  \
...
${OBJECTDIR}/_ext/414263ba/Symbole_nomain.o: ${OBJECTDIR}/_ext/414263ba/Symbole.o ../../M3105/tp5/Symbole.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/414263ba/Symbole_nomain.o ../../M3105/tp5/Symbole.cpp;\
	else  \
...
${OBJECTDIR}/_ext/414263ba/SymboleValue_nomain.o: ${OBJECTDIR}/_ext/414263ba/SymboleValue.o ../../M3105/tp5/SymboleValue.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/414263ba/SymboleValue_nomain.o ../../M3105/tp5/SymboleValue.cpp;\
	else  \
...
${OBJECTDIR}/_ext/414263ba/TableSymboles_nomain.o: ${OBJECTDIR}/_ext/414263ba/TableSymboles.o ../../M3105/tp5/TableSymboles.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/414263ba/TableSymboles_nomain.o ../../M3105/tp5/TableSymboles.cpp;\
	else  \
...
${OBJECTDIR}/_ext/414263ba/main_nomain.o: ${OBJECTDIR}/_ext/414263ba/main.o ../../M3105/tp5/main.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/414263ba/main_nomain.o ../../M3105/tp5/main.cpp;\
	else  \
