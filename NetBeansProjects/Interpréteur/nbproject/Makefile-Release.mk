...
${TESTDIR}/_ext/96b9438c/TestTantQue.o: ../../M3105/tp5/tests/TestTantQue.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/_ext/96b9438c/TestTantQue.o ../../M3105/tp5/tests/TestTantQue.cpp


${TESTDIR}/_ext/96b9438c/newtestrunner2.o: ../../M3105/tp5/tests/newtestrunner2.cpp 
	${MKDIR} -p ${TESTDIR}/_ext/96b9438c
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/_ext/96b9438c/newtestrunner2.o ../../M3105/tp5/tests/newtestrunner2.cpp
