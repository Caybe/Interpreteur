...
${TESTDIR}/_ext/96b9438c/newtestclass2.o: ../../M3105/tp5/tests/newtestclass2.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/_ext/96b9438c/newtestclass2.o ../../M3105/tp5/tests/newtestclass2.cpp


${TESTDIR}/_ext/96b9438c/newtestrunner4.o: ../../M3105/tp5/tests/newtestrunner4.cpp 
	${MKDIR} -p ${TESTDIR}/_ext/96b9438c
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/_ext/96b9438c/newtestrunner4.o ../../M3105/tp5/tests/newtestrunner4.cpp
